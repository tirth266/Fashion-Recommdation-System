     ...
     return (
          <div className="relative" ref={menuRef}>
               <button
                    ...
                    className="text-primary hover:text-secondary transition-colors focus:outline-none p-1 rounded-full border border-transparent dark:text-white dark:border-white"
                    title="Settings"
               >
               ...
               {isOpen && (
                    <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-100 dark:border-white py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
